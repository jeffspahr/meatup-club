...
CREATE INDEX IF NOT EXISTS idx_poll_sms_deliveries_poll_created ON poll_sms_deliveries(poll_id, created_at);
CREATE INDEX IF NOT EXISTS idx_poll_sms_deliveries_user_created ON poll_sms_deliveries(user_id, created_at);
CREATE UNIQUE INDEX IF NOT EXISTS idx_poll_sms_deliveries_provider_sid ON poll_sms_deliveries(provider_message_sid);
