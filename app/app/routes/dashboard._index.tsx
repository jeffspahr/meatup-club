...
export default function Dashboard({ loaderData }: Route.ComponentProps) {
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {content.length > 0 && (
        <div className="mb-8 rounded-2xl border border-border/50 bg-card/70 p-6 shadow-sm">
          ...
          {showContent && (
            <div className="space-y-4 mt-6">
              {content.map((item: any) => (
                <div key={item.id} className="rounded-2xl border border-border/50 bg-card/70 p-5 shadow-sm">
      ...
      {activePoll ? (
        <Link to="/dashboard/polls">
          <div className="mb-8 rounded-2xl border border-border/50 bg-card/70 p-6 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
      ...
      <div className="mb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {activePoll && (
            <Link to="/dashboard/polls">
              <div className="group rounded-2xl border border-border/50 bg-card/70 p-6 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
      ...
      <div className="mt-12 pt-8 border-t border-border/60">
        <div className="rounded-2xl border border-border/50 bg-card/70 p-6 text-center shadow-sm">
