...
### Goal
Push the last meaningful event lifecycle gaps higher: durable event email delivery branches, member/admin event route edges, and a few remaining dashboard home states.

### Acceptance Criteria
- [x] Expand `/private/tmp/meatup-test-bolster-20260323/app/app/lib/event-email-delivery.server.test.ts` and `/private/tmp/meatup-test-bolster-20260323/app/app/lib/event-email-delivery.additional.test.ts` with remaining recovery, timing, and helper-edge branches that still affect real delivery behavior.
- [x] Expand `/private/tmp/meatup-test-bolster-20260323/app/app/lib/email.server.notifications.test.ts`, `/private/tmp/meatup-test-bolster-20260323/app/app/lib/email.server.send.test.ts`, and `/private/tmp/meatup-test-bolster-20260323/app/app/lib/sms.server.test.ts` only where those tests still close event-delivery or provider-failure gaps.
- [x] Expand `/private/tmp/meatup-test-bolster-20260323/app/app/routes/dashboard.events.test.ts`, `/private/tmp/meatup-test-bolster-20260323/app/app/routes/dashboard.events.route-ui.test.tsx`, `/private/tmp/meatup-test-bolster-20260323/app/app/routes/dashboard.admin.events.test.ts`, `/private/tmp/meatup-test-bolster-20260323/app/app/routes/dashboard.admin.events.route-ui.test.tsx`, and `/private/tmp/meatup-test-bolster-20260323/app/app/routes/dashboard._index.route-ui.test.tsx` with the remaining real UI/action branches.
- [x] Refresh `/private/tmp/meatup-test-bolster-20260323/app/TESTING.md` so the documented baseline and remaining-gap summary match the latest verified run.
- [x] Verification passes: targeted tests, `npm run typecheck`, and `npm run test:coverage`.

### Active Tasks
- [x] Review the exact uncovered branches and identify the smallest credible test seams.
- [x] Add event delivery and provider-edge coverage in the existing helper suites.
- [x] Add route/action/UI coverage for remaining event and dashboard-state branches.
- [x] Run verification and capture the new baseline.
- [x] Refresh `TESTING.md`.

### Working Notes
- Keep this slice narrow. Skip static routes and low-value completeness work.
- Prefer extending existing suites over creating new test files unless a new colocated file materially improves clarity.
...
- Expanded helper/provider coverage in:
  ...
  - `/private/tmp/meatup-test-bolster-20260323/app/app/lib/sms.server.test.ts`
...
- Refreshed `/private/tmp/meatup-test-bolster-20260323/app/TESTING.md` to the current `705`-test baseline and remaining-gap summary.
- Verification performed:
  - `cd /private/tmp/meatup-test-bolster-20260323/app && npm run test:run -- app/lib/event-email-delivery.server.test.ts app/lib/event-email-delivery.additional.test.ts app/lib/email.server.notifications.test.ts app/lib/sms.server.test.ts app/routes/dashboard.events.route-ui.test.tsx app/routes/dashboard.admin.events.test.ts app/routes/dashboard._index.route-ui.test.tsx` passed (`119` tests).
  - `cd /private/tmp/meatup-test-bolster-20260323/app && npm run typecheck` passed.
  - `cd /private/tmp/meatup-test-bolster-20260323/app && npm run test:coverage` passed (`91` files, `705` tests).
- Coverage moved from `92.99%` statements / `80.76%` branches / `90.38%` functions to `93.92%` / `81.87%` / `91.79%`.

## Coverage Bolster Phase 3 (2026-03-23)

### Goal
Tighten the last meaningful event-lifecycle and provider integration gaps: durable email delivery, Twilio branches, member/admin event surfaces, and the dashboard home page states.

### Acceptance Criteria
- [x] Expand `/private/tmp/meatup-test-bolster-20260323/app/app/lib/event-email-delivery.server.test.ts` and `/private/tmp/meatup-test-bolster-20260323/app/app/lib/event-email-delivery.additional.test.ts` with the remaining skip, cancel, retry, and helper-edge branches.
- [x] Expand `/private/tmp/meatup-test-bolster-20260323/app/app/lib/email.server.notifications.test.ts`, `/private/tmp/meatup-test-bolster-20260323/app/app/lib/email.server.send.test.ts`, and `/private/tmp/meatup-test-bolster-20260323/app/app/lib/sms.server.test.ts` with the missing provider and parsing edge cases.
- [x] Expand `/private/tmp/meatup-test-bolster-20260323/app/app/routes/dashboard.events.test.ts`, `/private/tmp/meatup-test-bolster-20260323/app/app/routes/dashboard.events.route-ui.test.tsx`, `/private/tmp/meatup-test-bolster-20260323/app/app/routes/dashboard.admin.events.test.ts`, `/private/tmp/meatup-test-bolster-20260323/app/app/routes/dashboard.admin.events.route-ui.test.tsx`, `/private/tmp/meatup-test-bolster-20260323/app/app/routes/dashboard._index.test.ts`, and `/private/tmp/meatup-test-bolster-20260323/app/app/routes/dashboard._index.route-ui.test.tsx` with the remaining real workflow branches.
- [x] Refresh `/private/tmp/meatup-test-bolster-20260323/app/TESTING.md` so the baseline and remaining-gap summary match the latest verified run.
- [x] Verification passes: targeted tests, `npm run typecheck`, and `npm run test:coverage`.

### Active Tasks
- [x] Review the exact uncovered branches and the current test seams.
- [x] Add helper and provider-edge coverage in the email and SMS libraries.
- [x] Add route/action/UI coverage for the remaining event and dashboard branches.
- [x] Run verification and capture the new baseline.
- [x] Refresh `TESTING.md`.

### Working Notes
- Keep this slice focused on active product code with external side effects or mutation-heavy flows.
- Prefer filling gaps in the existing suites unless a new colocated test file materially improves clarity.

### Results
- Expanded helper coverage in:
  - `/private/tmp/meatup-test-bolster-20260323/app/app/lib/event-email-delivery.server.test.ts`
  - `/private/tmp/meatup-test-bolster-20260323/app/app/lib/event-email-delivery.additional.test.ts`
  - `/private/tmp/meatup-test-bolster-20260323/app/app/lib/email.server.send.test.ts`
  - `/private/tmp/meatup-test-bolster-20260323/app/app/lib/email.server.notifications.test.ts`
  - `/private/tmp/meatup-test-bolster-20260323/app/app/lib/sms.server.test.ts`
- Expanded route and UI coverage in:
  ...
  - `/private/tmp/meatup-test-bolster-20260323/app/app/routes/dashboard._index.route-ui.test.tsx`
- Refreshed `/private/tmp/meatup-test-bolster-20260323/app/TESTING.md` to the current `689`-test baseline and updated the remaining-gap summary.
- Verification performed:
  - `cd /private/tmp/meatup-test-bolster-20260323/app && npm run test:run -- app/lib/event-email-delivery.server.test.ts app/lib/event-email-delivery.additional.test.ts app/lib/email.server.send.test.ts app/lib/email.server.notifications.test.ts app/lib/sms.server.test.ts app/routes/dashboard.events.test.ts app/routes/dashboard.events.route-ui.test.tsx app/routes/dashboard.admin.events.test.ts app/routes/dashboard.admin.events.route-ui.test.tsx app/routes/dashboard._index.route-ui.test.tsx` passed (`151` tests).
  - `cd /private/tmp/meatup-test-bolster-20260323/app && npm run typecheck` passed.
  - `cd /private/tmp/meatup-test-bolster-20260323/app && npm run test:coverage` passed (`91` files, `689` tests).
- Coverage moved from the prior bolster baseline of `90.66%` statements / `78.16%` branches / `87.41%` functions to `92.99%` / `80.76%` / `90.38%`.

## Coverage Bolster Phase 2 (2026-03-23)

### Goal
Push the remaining event-lifecycle and delivery-path gaps higher, then refresh the testing guide to match the live baseline.

### Acceptance Criteria
- [x] Expand `/private/tmp/meatup-test-bolster-20260323/app/app/lib/event-email-delivery.server.test.ts` with remaining queue/retry/failure branches.
- [x] Expand `/private/tmp/meatup-test-bolster-20260323/app/app/lib/resend-setup.server.test.ts` and `/private/tmp/meatup-test-bolster-20260323/app/app/lib/provider-webhooks.server.test.ts` with missing helper/setup error branches.
- [x] Expand `/private/tmp/meatup-test-bolster-20260323/app/app/routes/dashboard.events.route-ui.test.tsx`, `/private/tmp/meatup-test-bolster-20260323/app/app/routes/dashboard.admin.events.route-ui.test.tsx`, `/private/tmp/meatup-test-bolster-20260323/app/app/routes/dashboard.admin.announcements.route-ui.test.tsx`, and `/private/tmp/meatup-test-bolster-20260323/app/app/routes/dashboard.polls.route-ui.test.tsx` with the remaining UI and boundary branches.
- [x] Refresh `/private/tmp/meatup-test-bolster-20260323/app/TESTING.md` so the documented baseline matches the latest verified coverage run.
- [x] Verification passes: targeted tests, `npm run typecheck`, and `npm run test:coverage`.

### Active Tasks
- [x] Review lessons, live coverage gaps, and existing test patterns.
- [x] Add helper/setup coverage for delivery and Resend setup code.
- [x] Expand member/admin event, announcement, and polls UI coverage.
- [x] Run verification and record the new baseline.
- [x] Refresh `TESTING.md`.

### Working Notes
- Focus on real event lifecycle risk: queue/retry behavior, delivery setup, admin resend surfaces, and member event interactions.
- Skip static or purely informational routes; use this slice only on meaningful product code.
...
- Expanded route/UI coverage in:
  ...
  - `/private/tmp/meatup-test-bolster-20260323/app/app/routes/dashboard.polls.route.test.ts`
  - `/private/tmp/meatup-test-bolster-20260323/app/app/routes/dashboard.polls.route-ui.test.tsx`
- Refreshed `/private/tmp/meatup-test-bolster-20260323/app/TESTING.md` to the current `658`-test baseline and the current remaining gap list.
- Verification performed:
  - `cd /private/tmp/meatup-test-bolster-20260323/app && npm run test:run -- app/lib/provider-webhooks.server.test.ts app/lib/resend-setup.server.test.ts app/lib/event-email-delivery.server.test.ts app/lib/event-email-delivery.additional.test.ts app/routes/dashboard.events.route-ui.test.tsx app/routes/dashboard.admin.events.route-ui.test.tsx app/routes/dashboard.admin.announcements.route-ui.test.tsx app/routes/dashboard.polls.route.test.ts app/routes/dashboard.polls.route-ui.test.tsx` passed (`83` tests).
  - `cd /private/tmp/meatup-test-bolster-20260323/app && npm run typecheck` passed.
  - `cd /private/tmp/meatup-test-bolster-20260323/app && npm run test:coverage` passed (`91` files, `658` tests).
- Coverage moved from the prior baseline of `88.76%` statements / `76.84%` branches / `84.44%` functions to `90.66%` / `78.16%` / `87.41%`.
